...
hoistedDependencies:
  ...
  create-jest@29.7.0(@types/node@22.8.7):
    create-jest: private
  cross-spawn@7.0.3:
    cross-spawn: private
  debug@4.3.7:
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@22.8.7):
    jest-cli: private
  jest-config@29.7.0(@types/node@22.8.7):
    jest-config: private
  jest-diff@29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 04 Nov 2024 08:40:15 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - fsevents@2.3.3
storeDir: /home/cody/.local/share/pnpm/store/v3
